...
public class GoodsDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String create_sql = "CREATE TABLE IF NOT EXISTS " + TABLE_NAME + " ("
                ...
                + "pic_path VARCHAR NOT NULL," + "type INTEGER NOT NULL"
                + ");";
    ...
    public ArrayList<GoodsInfo> query(String condition,String[] args) {
        String sql = String.format("select rowid,_id,name,desc,price,thumb_path,pic_path,type" +
    ...
    public GoodsInfo queryById(long rowid) {
        GoodsInfo info = null;
        ArrayList<GoodsInfo> infoArray = query(String.format("rowid='%d'", rowid),null);
        if (infoArray.size() > 0) {
