...
public class ShoppingChannelActivity extends AppCompatActivity implements OnClickListener {
    ...
    private Integer currentType = null; // 当前选中的商品类别
    ...
    private void showGoods() {
        ...
        // 查询商品数据库中指定的商品记录
        ArrayList<GoodsInfo> goodsArray = mGoodsHelper.query(query,null);
        int i = 0;
        for (; i < goodsArray.size(); i++) {
            ...
            btn_add.setBackgroundResource(R.drawable.button_shadow);
